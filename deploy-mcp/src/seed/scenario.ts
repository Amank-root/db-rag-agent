...
/** Baselines tuned so the analytics answer is unambiguous: checkout-api tops
 *  total errors (~3.3k) during the incident, payment-gateway is #2 (cascade). */
export const SERVICES: Record<string, ServiceProfile> = {
  ...
  "search-api":      { endpoint: "GET /v1/search",    rph: 1800, err: 0.004, p99: 210 },
